...
const OfflineAppointments = () => {
  ...
  const getDayClassName = (day) => {
    if (!day) return "w-12 h-12";
    
    const baseClasses = "w-12 h-12 rounded-lg flex items-center justify-center text-sm font-medium transition-all duration-200 cursor-pointer border";
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Clinic Schedule</h1>
          <p className="text-gray-600">Manage appointment availability</p>
        </div>
                    ...
                    {day ? (
                      <div className="relative">
                        ...
                        {(selectedDate === day.dateStr || hoveredDate === day.dateStr) && !day.isPast && (
                          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-800 text-white text-xs rounded whitespace-nowrap z-10">
                            {getDayStatus(day)}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Closed Days</span>
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-gray-900">Closed Days</h3>
